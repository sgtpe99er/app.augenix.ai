  ...
  'w-fit inline-flex items-center justify-center whitespace-nowrap text-sm rounded-md font-alt font-medium transition-colors disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        emerald: 'bg-emerald-500 text-white hover:bg-emerald-400 font-semibold',
        sexy: 'transition-all duration-200 bg-gradient-to-r from-orange-500 via-pink-500 to-blue-500 text-white font-medium hover:font-bold hover:text-lg hover:tracking-wider',
      },
      size: {
        default: 'h-10 px-4',
...
export function WithSexyBorder({
  ...
  // No longer using SexyBoarder - sexy variant now uses gradient background
  return <>{children}</>;
}
